/* http://angelus.local/wp-content/themes/angelus-plongee-child/assets/js/custom.min.js */
try{
(function($){$(document).ready(function(){ $('button.openBtn').on('click',function(event){event.preventDefault(); $id=$(this).attr('data-href');$('.modal.fade').attr('id',$id);let post_slug=$('.modal').attr('id');let post_title=$('.modal_title').html();let modal_html=$('.modal-body').html(); $.ajax({url:frontend_ajax_object.ajaxurl,type:"POST",data:{'action':'load_page_modal','post_slug':$id,'post_title':post_title}}).done(function(response){$('#modal-home').html(response);});}); $('button.closed').on('click',function(event){event.preventDefault();$('.modal-body').empty();})
setTimeout(function(){if(window.scrollY===0){jQuery('#backtop').fadeOut(1000);}},300);window.onscroll=function(){let scrollPos=document.documentElement.scrollTop||document.body.scrollTop;if(scrollPos<200){jQuery('#backtop').fadeOut(2000);}
else if(scrollPos>201){jQuery('#backtop').fadeIn(2000);}}; window.onorientationchange=function(){let orientation=window.orientation;switch(orientation){case 0:case 90:case-90:window.location.reload();break;}};
let windowHeight=$(window).height();$(window).resize(function(){if(windowWidth!=$(window).width()||windowHeight!=$(window).height()){location.reload();return;}}); setTimeout(function(){ let viewheight=$(window).height();let viewwidth=$(window).width();let viewport=document.querySelector("meta[name=viewport]");viewport.setAttribute("content","height="+viewheight+", width="+viewwidth+", initial-scale=1.0");},300);
 window.addEventListener('resize',()=>{ let vh=window.innerHeight*0.01; document.documentElement.style.setProperty('--vh',`${vh}px`);}); $('p').each(function(index,item){if($.trim($(item).text())===""){$(item).remove();}}); $('.slick-carousel').slick({dots:true,infinite:true,speed:500,slidesToShow:1,adaptiveHeight:false,autoplay:true,autoplaySpeed:15000,arrows:false,mobileFirst:true}); $('.count-up').each(function(){let $this=$(this);jQuery({Counter:0}).animate({Counter:$this.text()},{duration:1000,easing:'swing',step:function(){$this.text(Math.ceil(this.Counter));}});}); let $cross=$(".card .card-header h5");$cross.click(function(e){e.preventDefault();$cross.not(this).addClass('add-before').removeClass('open');$(this).toggleClass('add-before open');}); $(".card h5").click(function(){var currentWidth=$(window).width();var xScroll=currentWidth<767?0:170;$('html, body').animate({scrollTop:$('#accordion').offset().top-xScroll},1000);}); let $container=$("#partners");let $openPartners=$('.btn-open');let $closeCross=$(".close-cross");$openPartners.on('click',function(event){event.preventDefault();
if($container.is(":visible")){$container.slideUp(500);$container.attr('aria-hidden','true');$openPartners.addClass('close-partners');$openPartners.removeClass('open-partners');$closeCross.fadeOut(800);}else{$container.slideDown(800);$container.removeAttr('aria-hidden');$openPartners.addClass('open-partners');$openPartners.removeClass('close-partners');$closeCross.fadeIn(200);}});$closeCross.on('click',function(event){event.preventDefault();$container.slideToggle(400,function(){$closeCross.fadeOut(100);});$openPartners.addClass('close-partners');}); $('a.top, .smooth-scroll').on('click',function(e){let $urlSection=$(this).attr('href'); e.preventDefault(); const $urlBase=new URL('http://www.angelus-plongee.com/'+$urlSection);newHash=$urlBase.hash; $('html, body').animate({scrollTop:$(newHash).offset().top},600,function(){jQuery('#backtop').fadeOut(2000);
window.location.hash=newHash;});});let navigation=$('.navigation.topnav'),windowWidth=$(window).width();if(windowWidth<960){ $(function(){$('.bar-menu').on('click',function(){$('#burgerMenu').slideToggle();});}); $(document).on('click',function(event){if(!$(event.target).closest('.bar-menu').length){$('#burgerMenu').slideUp();}});}
heightAdaptWindow=()=>{let heightMenu=$('#container-main-menu').outerHeight(true);let heightHomeBody=$(window).height();let heightMobileMenu=$('#mobile-menu').outerHeight(true);let heightTitle=$('h1').outerHeight(true); let heightSubTitle=$('h2.sub-title').outerHeight(true);let heightCTA=$('.cta_home').outerHeight(true);if(windowWidth>960){let heightHomeSection=heightHomeBody-(heightTitle+heightMenu+heightSubTitle+heightCTA);$('#home').css('height',heightHomeSection);}
else if(windowWidth<960&&$('#mobile-menu').length){let heightHomeSection=heightHomeBody-(heightTitle+heightMobileMenu+heightSubTitle+heightCTA);$('#home').css('height',heightHomeSection);}}
heightAdaptWindow();});})(jQuery);

}
catch(e){console.error("An error has occurred: "+e.stack);}
/* http://angelus.local/wp-content/themes/angelus-plongee-child/slick/slick.min.js */
try{
...
/* http://angelus.local/wp-content/themes/Angelus-Plongee/bootstrap/dist/js/bootstrap.min.js */
try{
/*!
...
/* http://angelus.local/wp-content/themes/Angelus-Plongee/js/navigation.js */
try{
...
/* http://angelus.local/wp-content/themes/Angelus-Plongee/js/skip-link-focus-fix.js */
try{
...
/* http://angelus.local/wp-includes/js/jquery/ui/core.min.js */
try{
/*!
...
/* http://angelus.local/wp-includes/js/jquery/ui/widget.min.js */
try{
/*!
...
/* http://angelus.local/wp-includes/js/jquery/ui/mouse.min.js */
try{
/*!
...
/* http://angelus.local/wp-includes/js/jquery/ui/slider.min.js */
try{
/*!
...
/* http://angelus.local/wp-includes/js/wp-embed.min.js */
try{
